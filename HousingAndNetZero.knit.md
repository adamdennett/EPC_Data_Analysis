...
::: columns
::: {.column width="50%"}
-   'Retrofitting' homes is the process of improving insulation, ventilation and air-tightness alongside upgrading heating (e.g. to heat-pumps), lighting and installing smart control devices. Doing all of this at once is known as 'Deep Retrofit.'
-   Retrofitting also has other benefits - for example, for health. The Building Research Establishment [estimates that poor housing costs the NHS £1.4bn per year in additional treatments](https://bregroup.com/news-insights/the-cost-of-poor-housing-to-the-nhs/), with excess cold causing the most problems.
-   A mass programme of retrofitting could also create thousands of jobs, benefiting the wider economy; and help improve our energy security, making us less reliant on imported fossil gas for heating
...
::: columns
::: {.column width="50%"}
-   With the cost of retrofit so expensive - and the route to doing it unclear for many people - proper incentives such as funding or tax incentives from central government alongside schemes to help home-owners need devising
-   The Insulate Britain pressure group highlights that UK government doesn't have a long-term strategy or funding mechanism to upgrade/retrofit homes to meet our climate commitments
-   Estimates that 1.5 homes per minute need to be retrofitted up until 2050 to hit our legally-binding net-zero target - something that we are currently far from achieving.
:::
...
-   How old is the housing in your area?
